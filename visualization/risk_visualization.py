...
def run_risk_analysis(normalized_features, feature_names, audio_features):
    """
...
def plot_risk_visualization(features, risk_indices, feature_names, audio_features):
    """
    ...
    if n_components == 1 or pca_results.shape[1] == 1:
        ...
        if risk_indices:
            ...
            for idx in risk_indices:
                ...
                plt.annotate(
                    sample_id,
                    (pca_results[idx, 0], 0),  # Fixed: Previously had a0 variable which was undefined
                    xytext=(5, 5),
